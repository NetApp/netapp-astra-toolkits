...
usage: actoolkit unmanage [-h] {app,bucket,cloud,cluster,ldap} ...

options:
  -h, --help            show this help message and exit

objectType:
  {app,bucket,cloud,cluster,ldap}
    app                 unmanage app

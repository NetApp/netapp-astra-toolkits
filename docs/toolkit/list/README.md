...
`list namespaces` shows all non-system namespaces of all of the managed clusters.  They can also be filtered by a cluster ID.
...
+-----------+--------------------------------------+--------------------------------------+
| name      | namespaceID                          | clusterID                            |
+===========+======================================+======================================+
| default   | fdc47134-110c-44bf-8509-2cc15a437da0 | af0aecb9-9b18-473f-b417-54fb38e1e28d |
+-----------+--------------------------------------+--------------------------------------+
| default   | 582e8b9b-3083-437f-ae86-ea0d3fc543a3 | b81bdd8f-c2c7-40eb-a602-4af06d3c6e4d |
+-----------+--------------------------------------+--------------------------------------+
| wordpress | 1d1f210a-f37a-4474-b8df-1b4605090f10 | b81bdd8f-c2c7-40eb-a602-4af06d3c6e4d |
+-----------+--------------------------------------+--------------------------------------+
| cassandra | 61a6aacc-4eb9-4cb2-92e6-e3409945f993 | af0aecb9-9b18-473f-b417-54fb38e1e28d |
+-----------+--------------------------------------+--------------------------------------+
```

```text
$ ./toolkit.py list namespaces -c af0aecb9-9b18-473f-b417-54fb38e1e28d
+-----------+--------------------------------------+--------------------------------------+
| name      | namespaceID                          | clusterID                            |
+===========+======================================+======================================+
| default   | fdc47134-110c-44bf-8509-2cc15a437da0 | af0aecb9-9b18-473f-b417-54fb38e1e28d |
...
```text
$ ./toolkit.py list namespaces -f word
+-----------+--------------------------------------+--------------------------------------+
| name      | namespaceID                          | clusterID                            |
+===========+======================================+======================================+
| wordpress | 1d1f210a-f37a-4474-b8df-1b4605090f10 | b81bdd8f-c2c7-40eb-a602-4af06d3c6e4d |

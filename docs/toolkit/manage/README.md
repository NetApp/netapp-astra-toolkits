...
```text
usage: toolkit.py manage [-h] {app,bucket,cloud,cluster} ...
...
```text
./toolkit.py manage cluster <clusterID> <--defaultStorageClassID optionalDefaultStorageClassID>
```

Sample output:

```text
$ ./toolkit.py manage cluster 062728da-ef0c-4dc2-83f9-bedb07c30511
